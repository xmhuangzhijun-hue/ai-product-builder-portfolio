...
page('about.html','关于我','XMHUA：面向 AI 产品与 AI 应用开发岗位，展示需求判断、AI 协作实现与开源实践。',f'''<section class="wrap about-page"><p class="eyebrow">ABOUT XMHUA</p><h1>关注问题，<br>也把想法<span class="accent">做出来。</span></h1><p class="about-intro">我关注 AI 产品、Agent 应用与知识系统。习惯从具体使用场景出发，先理解问题，再借助 AI 推进产品设计、实现、调试与验证。</p>
