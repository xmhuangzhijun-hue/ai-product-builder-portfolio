...
projects = [
    ...
    ('shell','自有扩展项目 · 基于上游 Harness','Agent 手机接入原型：先验证登录与连接。','UI 插槽接入、TLS 登录、WebSocket 代理与 Host 信任配置；不修改上游源码。','TypeScript / Node.js / TLS · 单人 LAN'),
...
ROLES = {
 ...
 'shell': ('交互外壳 + 登录网关 + 连接验证', '定位页面可见却连不上会话的问题；完整手机任务仍待验收。'),
